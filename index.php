    ...
    if ( isset($_POST['get_holidays']) ) {
        ...
        if ( (isset($_POST['country']) && !empty($_POST['country']))
            ...
            function free_day_row_count($grouped) {
                ...
                foreach ($grouped as $month_name => $holiday_group) {
                    $row_count = 0;
                    $next_date = '';
                    foreach ($holiday_group as $single_holiday) {

                        $current_date = strtotime(get_formated_date($single_holiday));
...
<html>
    ...
    <body>
        ...
        <form method="post" enctype="multipart/form-data">
            <input type="number" min="2011" step="1" name="year" />
                ...
                $("button").click(function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function (resp) {
                            ...
                            $(".results").append("<p>Maximum number of holidays in row: " + data.free_days_in_row_count + "</p><hr/>");
